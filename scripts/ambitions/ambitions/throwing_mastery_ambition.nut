this.throwing_mastery_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "The warband lacks competent throwers, limiting our charge.\nWe shall train three men to master ranged weapons and support our charge!";
		this.m.UIText = "Have men with the throwing mastery perk";
		this.m.TooltipText = "Have " + this.m.Required + " men with the throwing mastery perk.";
	...
	function getUIText()
	{
		return this.m.UIText + " (" + this.Math.min(3, this.getBrosWithMastery()) + "/" + this.m.Required +")";
	}
