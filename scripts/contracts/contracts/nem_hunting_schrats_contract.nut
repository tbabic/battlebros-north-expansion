this.nem_hunting_schrats_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	m = {
		Target = null,
		Dude = null,
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_hunting_schrats";
