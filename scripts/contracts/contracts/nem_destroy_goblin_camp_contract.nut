this.nem_destroy_goblin_camp_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_destroy_goblin_camp";
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Task",
			Title = "Negotiations",
			Text = "[img]gfx/ui/events/event_61.png[/img]{%employer%\'s yelling at a man leaving his room. When he settles down, he bids you a fair greeting.%SPEECH_ON%Farkin\' hell, it\'s good to see you. Do you have any notion as to how hard it is to get your \'loyal\' men to go kill some goblins?%SPEECH_OFF%He spits and wipes his mouth on his sleeve.%SPEECH_ON%Apparently it is not the most noble of tasks. Something about how those little gits don\'t ever fight fair. Can you believe that? Men telling me, a chieftain, what is \'noble\' or not. Well, there it is anyway, warrior. I need you to go %direction% of %origin% and root out some goblins that have set up a camp. Can you do that for me?%SPEECH_OFF% | %employer%\'s unsheathing and sheathing a sword. He seems to look at himself in the blade\'s reflection before snapping it away again.%SPEECH_ON%The clansfolk are badgering me again. They say there are goblins camping at a place called %location% %direction% of %origin%. I\'ve no reason to disbelieve them after a young boy was brought to my feet today, a poison dart in his neck.%SPEECH_OFF%He slams the sword into its scabbard.%SPEECH_ON%Are you willing to take care of this problem for me?%SPEECH_OFF% | Red in the face, a drunken %employer% slams a mug down when you enter his room.%SPEECH_ON%Warrior, right?%SPEECH_OFF%His guard looks in and nods. The chieftain laughs.%SPEECH_ON%Oh. Good. More men to send to their deaths.%SPEECH_OFF%He pauses before bursting into laughter.%SPEECH_ON%I joke, what a joke, right? We are having an issue with some goblins %direction% of %origin%. I need you to go take care of them, are you -hic- up for that or should I go ask someone else to dig their own... I mean...%SPEECH_OFF%He shuts himself up with another drink. | %employer% breaks bread as you enter, but he doesn\'t share any. He dips both ends into a goblet of wine and stuffs his mouth. He speaks, but it\'s more crumbs than words.%SPEECH_ON%Good seeing you, warrior. I have some goblins %direction% of %origin% that need rooting out. I\'d send my warriors to go take care of them, but they\'re, uh, few in number and needed here. I\'m sure you understand.%SPEECH_OFF%He manages to stuff the rest of the bread into his ugly maw. | When you find %employer%, he\'s sending off a few of his clansmen, chasing them out the door with a few parting curses. The sight of you, however, seems to momentarily settle the man.%SPEECH_ON%Warrior! Good to see you! Better you than those so-called \'men\'.%SPEECH_OFF%He takes a seat and pours himself a drink. He takes a sip, stares at it, then downs it all in one go.%SPEECH_ON%My loyal warriors refuse to go take on the goblins which have camped %direction% of %origin%. They talk of ambushes, poison, all that...%SPEECH_OFF%His speech is increasingly slurred.%SPEECH_ON%Well... -hic-, you know all that, right? And you know what I\'m asking next, right? Of - of course you do, -hic-, I need you to hand me another drink! Ha, kidding. Go kill those goblins, wouldya?%SPEECH_OFF%}",
			Image = "",
			List = [],
			ShowEmployer = true,
			ShowDifficulty = true,
