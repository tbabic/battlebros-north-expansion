	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			Options = [
				...
				{
					Text = "{This doesn\'t sound like warrior work. | This doesn\'t sound like our kind of work. | That\'s not the kind of work we\'re looking for.}",
					function getResult()
					{
