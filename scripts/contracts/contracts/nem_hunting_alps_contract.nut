this.nem_hunting_alps_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_hunting_alps";
		...
		this.m.States.push({
			...
			function start()
			{
				this.Contract.m.BulletpointsObjectives = [
					"End the nightmares haunting " + this.Contract.m.Home.getName() + " at night"
				];
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Task",
			Title = "Negotiations",
			Text = "[img]gfx/ui/events/event_79.png[/img]{%employer% is found with a pillow in hand. A man at his side is touching its linens before bringing it to his nose. He sniffed it thrice and then shook his head before seeing fit to sniff it again anyway. %employer% waves you in.%SPEECH_ON%A clansman around these parts is reporting that a strange spirit is invading his sleep. He\'s offered his nightly adornments as evidence, but we know not what to make of them.%SPEECH_OFF%You look at the strange man who is nose deep in the linens again. You raise an eyebrow and state you can investigate this matter yourself. %employer% nods.%SPEECH_ON%Precisely why I\'m glad you\'re here. I want you to stick around a night or two and see if anything spooky comes out at night. I\'m sure it\'s nothing, but I\'ll pay you regardless of what shows. What say you, does this pique your interest?%SPEECH_OFF%The strange man is almost clutching into the pillow and drawing in gaping breaths as though suffocating himself. He asks if he can keep the pillow. | You find %employer% listening to a villager tell a tale, but upon seeing you the man suggests the clansman tell it to you instead. He explains that he and many other families have been suffering horrible dreams lately. Not only this, but pets have gone missing and some children have reported being stolen away and having to walk back to their homes in the dead of night. %employer% nods.%SPEECH_ON%The whole camp is on pins and needles about this, warrior. I\'ve heard tales of %enemy%, ghoulish cretins that feast upon one\'s dreams, but I\'m sure it\'s just some damn kids up to no good. Either way, a purse has been collected and I\'m prepared to dole it out for more proper protection. Are you interested?%SPEECH_OFF% | %employer% sits at his desk. He sighs heavily.%SPEECH_ON%Damn clansmen are going on about %enemy% this, %enemy% that. Seems like a mountain of shit on my shoulders these days, or a mountain range even!%SPEECH_OFF%The man takes a seat and pours himself a mug of ale. He downs it quickly.%SPEECH_ON%Dream eaters this, stalkers of the night that, bah! Absolute rubbish. Well, the fools put together a chest of coin and are willing to give it out for some protection. I want you to stick around a night or two and see if these supposed spirits are real or we just got some tricksters on our hands. Are you interested?%SPEECH_OFF% | %employer% has his head in his hands and it turns side to side. You ask if you should come back another time. He slams his fists into the table.%SPEECH_ON%No! This is the perfect time. The clansmen have been complaining of strange dreams for days now. And last night a nightmare visited upon me. I can\'t even make sense of it. I was standing in a field of wheat and I saw shadows passing through the stalks. But they weren\'t just shadows, they were flattening the wheat as they went and... well, when I woke I saw the legs of something just as they ran out my door. I... I mean we want you to stay the night and see if anything comes for you, too. Are you interested?%SPEECH_OFF% | %employer% is found turning a small wooden trinket between his thumb and finger. It is shaped like a horned man. He throws it on his desk and nods at it.%SPEECH_ON%Carpenter made that. Said it visited him in the night. I said when. He said in his dreams, and it was at the foot of his bed when he awoke. Then, today, three entire families come to me stating they\'d seen the same and that every one of their dogs are missing. Not found. Just gone. I know not what festers in these ungodly parts, warrior, but I won\'t spend another night without some steel at our side. Are you interested in protecting %townname% for a night or two?%SPEECH_OFF%}",
			Image = "",
			List = [],
			ShowEmployer = true,
			ShowDifficulty = true,
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_79.png[/img]{%employer% asks to see the alp\'s remains. You take it out of the bag. The flesh has deflated and you hold the head more like a scalp than a skull. The  chieftain touches it with his finger and the alp skin twists away like snakeskin. He asks if they fought well. You shrug.%SPEECH_ON%Hardy creatures to be certain, but I won\'t lose sleep over them.%SPEECH_OFF%The man nods reluctantly.%SPEECH_ON%Right. Well, here is your reward as promised. And throw that awful thing away.%SPEECH_OFF% | You dump the alp\'s head onto %employer%\'s desk. It flops over the wood until its maw rests wide, its emptied eyesockets drooping sadly at the world above. %employer% takes a fire iron and fishes around the skull before hanging its shapelessness in the air.%SPEECH_ON%What an awful thing this is. I should let you know that many folks came to me just hours ago stating they\'d visions of fields being bathed in a glorious light. Like they\'d dreamt the renewal of the world whole. So I don\'t know if every last one of these monsters is gone, but it seems %townname%\'s plight has been well taken care of. I\'ll see to it that you get your reward as promised.%SPEECH_OFF% | %employer% meets you in his room and laughs at the knapsack you\'ve brought. He shakes his head as he pours a drink.%SPEECH_ON%You need not show me that foul thing\'s face, warrior. It visited me just hours ago, while I was sitting right there writing notes, an intrusion that was a dream, a sight of its death as though its spirit had been severed from mine and I was forced to see it go. And in its leaving I saw you standing there, sword in hand, victorious as all get out.%SPEECH_OFF%You nod and ask if you looked good. He laughs.%SPEECH_ON%You looked a slayer of worlds, certainly a slayer of that creature\'s world and, I must fear, perhaps a bit of mine as well. Stolen, permanently. Well, no matter, I as a man whole or a man sundered, I\'ve promised you a good pay and here it is.%SPEECH_OFF%}",
			Image = "",
			Characters = [],
			List = [],
			ShowEmployer = true,
			Options = [
				{
					...
					function getResult()
					{
						...
						this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractSuccess, "Rid the camp of unnatural nightmares");
