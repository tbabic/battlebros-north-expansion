this.nem_destroy_orc_camp_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_destroy_orc_camp";
