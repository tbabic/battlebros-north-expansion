this.nem_destroy_orc_camp_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Volunteer1",
			Title = "After the battle...",
			Text = "[img]gfx/ui/events/event_32.png[/img]{Cleaning your blade, a voice pipes in from a collapsed orcish tent.%SPEECH_ON%Good men, you\'ve done it!%SPEECH_OFF%You watch as a grinning man emerges.%SPEECH_ON%You\'ve freed me! And I\'d like to repay that service you\'ve done by offering my hand!%SPEECH_OFF%He holds his hand out, pauses, then takes it back.%SPEECH_ON%I mean to fight for you! I\'d like to fight for you, sir! If you can do all this, then surely I\'d be in good company, right?%SPEECH_OFF%Hmm, an interesting offer. You toss him a weapon and he catches with ease. He twists the handle about, twirling it hand-over-hand before trying to sheathe it into an invisible scabbard.%SPEECH_ON%The name\'s %dude_name%.%SPEECH_OFF% | A man in tattered and dented armor comes sprinting toward you. His arms are tied behind his back.%SPEECH_ON%You did it! I can\'t believe it! Sorry, let me explain my immodesty. I was captured by the orcs a day ago as we tried to take the camp. I think they were about to put me on a spit when you showed up. I took the first moment I could to make my escape, but now I see you and your group might be worth joining.%SPEECH_OFF%You ask the man to get to the point. He does.%SPEECH_ON%I\'d like to fight for you, sir. I\'ve got experience - been with the lord\'s army, a sellsword, and... well, other things.%SPEECH_OFF%}",
			Image = "",
			Characters = [],
			List = [],
			Options = [
