this.nem_hunting_hexen_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	m = {
		Target = null,
		Dude = null,
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			function start()
			{
				...
				this.Text += "{%SPEECH_ON%Stop! Stop right there!%SPEECH_OFF%Her voice is soothing and calming, like an echo traveling through the age. Yet at the same time it is a voice of authority and commanding, leaving no option but to stand still like a mountain. You shake your head, muster all of you strength and try to make a step forward. It is a long and hard step, but you make it none the less and as your foot touches the ground the spell breaks and the weight falls from you. The witch speaks again, but this time her voice is broken and raspy and almost crying. %SPEECH_ON%You are indeed blessed by destiny. Let me live and I will not return here. You will not see me again.%SPEECH_OFF%You shake your head and make another step towards her, raising your sword and preparing to bury it in her head. Suddenly she produces a tiny vial in each hand, one carrying a drop of green liquid, the other blue.%SPEECH_ON%Wait! A drink for the body, or for the spirit. Men would kill for either. I offer you one in exchange for my life.%SPEECH_OFF%}"
			}
		});
