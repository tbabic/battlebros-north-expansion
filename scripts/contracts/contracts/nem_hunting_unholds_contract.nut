this.nem_hunting_unholds_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_hunting_unholds";
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Task",
			Title = "Negotiations",
			Text = "[img]gfx/ui/events/event_79.png[/img]{When you enter %employer%\'s room you find the man stooped beside his window, looking out it with nearly conspiratorial flinching. His eyes slim and open wide and slim again. He snaps a curtain over the window and jerks his head to look at you.%SPEECH_ON%You didn\'t happen to see a very angry woman heading my way, did you? Ah, nevermind it. Look at this.%SPEECH_OFF%He hands you piece of paper, there\'s a crude drawing of what looks like a man hunched over an ant or some insect. You can\'t really tell. %employer% claps his hands.%SPEECH_ON%Local farmers are reporting missing livestock. All they found were footprints large enough for a man to lay a coffin in. Sounds like hearsay and rumormongering to me, could be rivals trying to hide their misdoings, but I\'ll leave you to it. Search the surrounding lands and see what you find. If you come upon an actual giant I think you know what do.%SPEECH_OFF% | You find %employer% staving off a throng of villagers. They\'ve entered his room with pitchforks and unlit torches, which he must constantly warn them not to light given the all-wood architecture. Seeing you, %employer% calls out like a drowning man yelling for a raft.%SPEECH_ON%Warrior! By the gods get over here. These fine folks state that there is a beast afoot.%SPEECH_OFF%One of the clansmen stomps his pitchfork into the ground.%SPEECH_ON%Naw, no ordinary beast, but a monster ya? A giant! A biggun. A big ol\' giant. Out there. Right out that way. I seen it.%SPEECH_OFF%With a sigh and a nod, %employer% butts back in.%SPEECH_ON%Right. So, I\'m willing to offer you payment to seek this giant out. Are you up to the task?%SPEECH_OFF% | %employer% is at his desk with his head in his hands. He\'s mumbling to himself.%SPEECH_ON%Monster this, beast that. \'Oh my chicken got taken\', oh maybe you should consider putting it in a pen you damned piece of - oh hi warrior!%SPEECH_OFF%The man rises from his chair and throws you a piece of paper. There\'s a crude drawing of a large headed beast on it.%SPEECH_ON%Folks are reporting there\'s a giant roaming around these parts. I\'ll pay good money to see these reports investigated properly, and of course good money to see the beast slain properly as well. Are you up for it? Please say yes.%SPEECH_OFF% | %employer% reluctantly welcomes you into his room, pretending that he doesn\'t need your help, thought it\'s clear he\'d rather not want it at all.%SPEECH_ON%Ah, warrior. It\'s not often a place such as %townname% would seek out men of your ilk, but I\'m afraid there have been sightings of unholds scouring these lands, stealing enough livestock that the clannsfolk have put in the coin to fetch a man such as yourself. Are you interested in hunting down this foul creature?%SPEECH_OFF%}",
			Image = "",
			List = [],
			ShowEmployer = true,
			ShowDifficulty = true,
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_113.png[/img]{The unholds slain, you order the men to take what trophies they can as proof of your work, and possibly as something to use for yourself. If man can make leather from a cow, surely there\'s something worthy of giants such as these? Either way, %employer% will be waiting. | With the giants slain to the last, %employer% should be awaiting your return now. His camp will be forever safe now and no longer require the services of warriors such as yourself. You dwell on the thought until you start a laughing fit to which none of your men understand. You tell them to ignore it and round them up for the return trip. | The ghastly monsters put up a hell of a fight, but they were no match for the collective strength, smarts, and sheer balls of the %companyname%. You tell the men to take what trophies they can and to prepare for the return march to %employer%. | With the last of the unholds slain, you round up the men. %randombrother% is found jumping on one\'s belly and seems disappointed when you tell him to quit it and get down. %employer% will be looking for killers and their trophies, not a bunch of children.}",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_79.png[/img]{%employer% welcomes your return, almost immediately stating that he hasn\'t heard a single story of the unholds\' ravaging since you left. You nod and present evidence of the reason why, the slick remains of the slain giants sputtering as you bowl them across his floor. The wood is stained as though you\'d unfurled a carpet. The mayor purses his lips.%SPEECH_ON%What the hell, warrior?%SPEECH_OFF%You cock your head and raise an eyebrow. The man lets his hands fall and he bows a bit.%SPEECH_ON%Ah, no worries! All is well! Here, your reward as promised!%SPEECH_OFF% | You return to %employer% and find the man reading stories to children. He rends his hand through the air and growls like a beast. Knocking on the door, you intrude upon the theater.%SPEECH_ON%Aye, and then the ever honorable warriors slew the monster!%SPEECH_OFF%The children cheer at your timely arrival. The mayor stands and gives you the promised reward, declaring he had a scout following your every move and he\'s already heard the reports of your success. He asks if you\'ll stick around and tell the tale for the kiddos. You tell him you don\'t work for free and leave the room. | You have to root about the camp a while to find %employer%, the man himself found kept up in his room by a young lass who hides beneath the sheets you caught them in. The mayor gets dressed with no hesitation as to his own nakedness. He pitches a coin toward the girl and then speaks to you.%SPEECH_ON%Aye, warrior, I\'ve been expecting you! Your reward, as promised!%SPEECH_OFF%He gives you the satchel, but a coin slips free and runs between the floorboards. The man purses his lips a moment then runs back to the girl and snatches the coin out of her hands and drops it in the satchel. | You report to %employer% of your doings and he is, surprisingly not incredulous in the least.%SPEECH_ON%Aye, I had a scout tracking your company and he\'d beaten you back to camp. Every word you say mirrors his. Your pay, as promised.%SPEECH_OFF%He hands you a satchel.}",
			Image = "",
			Characters = [],
			List = [],
			ShowEmployer = true,
