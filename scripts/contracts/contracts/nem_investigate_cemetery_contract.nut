this.nem_investigate_cemetery_contract <- this.inherit("scripts/contracts/barbarian_contract", {
	m = {
		Destination = null,
	...
	function create()
	{
		...
		this.m.Type = "contract.nem_investigate_cemetery";
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Failure1",
			Title = "On your return...",
			Text = "[img]gfx/ui/events/event_63.png[/img]{%employer% is standing at the window when you enter.%SPEECH_ON%The songbirds seemed rather angry today. As though nothing they\'d say was worth saying. I thought that was interesting. Do you?%SPEECH_OFF%He suddenly turns toward you.%SPEECH_ON%Hmm? No? My little birds told me that the graverobbers are alive. Free to go where they please, free to return as they please. What an oddity, because usually dead men aren\'t free to do anything. What did I ask you to make those graverobbers?%SPEECH_OFF%You hesitate. The man answers for you.%SPEECH_ON%I wanted you to make them dead. Now they aren\'t. Now you don\'t get paid. Ah, how simple. And now? Now you get out of my home.%SPEECH_OFF% | %employer% laughs as you enter his room.%SPEECH_ON%I\'m honestly surprised you returned. I should find it insulting, really, that you\'d think I wouldn\'t know better. The graverobbers were spotted on the road. The graverobbers I asked you to kill. Remember that? Remember when I said go and kill them? I\'m sure you do. I\'m also sure you remember when I said that\'s what I was paying you for. So... no dead graverobbers...%SPEECH_OFF%He slams his desk with a fist.%SPEECH_ON%No pay! Now get out of my home!%SPEECH_OFF% | You find %employer% in his chair, rolling an empty goblet between his hands.%SPEECH_ON%It\'s not often I run across someone who tries to cheat me. That\'s what you were going to do, coming back here, right? I know the graverobbers aren\'t dead, warrior. I\'m no fool. Leave my sight before I have my men butcher you.%SPEECH_OFF% | %employer% is reading a book when you enter his room.%SPEECH_ON%You have ten seconds to turn around and leave. Ten. Nine. Eight...%SPEECH_OFF%You realize he knows that the graverobbers were not taken care of.%SPEECH_ON%...four... three...%SPEECH_OFF%You turn and hastily leave the room.}",
			Image = "",
			List = [],
			ShowEmployer = true,
			Options = [
