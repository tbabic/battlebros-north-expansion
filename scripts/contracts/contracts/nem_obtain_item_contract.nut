this.nem_obtain_item_contract <- this.inherit("scripts/contracts/contract", {
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			ID = "Failure1",
			Title = "On your return...",
			Text = "[img]gfx/ui/events/event_43.png[/img]{The townsfolk of %townname% are eagerly awaiting your return. A shame, because you don\'t have the relic that they so desperately need. %employer%, seeing your failure a step ahead of the laymen, meets you at the town entrance and talks to you in whispers.%SPEECH_ON%I take it you do not have the %item%.%SPEECH_OFF%You try to explain all that happened, but he does not seem to listen.%SPEECH_ON%It\'s no matter, warrior. I can\'t pay you, obviously, and the townsfolk shan\'t hear of your shortcomings lest we have them lose their minds. They depend upon idols to find comfort in this world. I will have to come up with my own solution and, well, pray it works. Good day.%SPEECH_OFF% | %employer% meets you beside a host of geese. He\'s feeding them out of hand while, quite casually, a boy will occasionally come by and simply pick up one of the birds and go off with it for a slaughtering. The man smiles warmly at you, but his excitement quickly sours.%SPEECH_ON%I do not see the relic. Am I right to believe you do not have it?%SPEECH_OFF%A simple nod is all you give as an answer. He opens his arms, somewhat confused.%SPEECH_ON%Then why have you come? The townsfolk know you. They know you were out there looking for it. You should leave before they see you\'ve returned without their godly idol.%SPEECH_OFF% | You return to %employer% emptyhanded. He takes you by the side and whispers.%SPEECH_ON%And why have you come at all? Do you not understand what import these townsfolk have put upon the idol? Without it to worship, they\'ll have nothing to believe in. Men of strong faith needs somewhere to put it. If he can\'t find it, all he finds is himself. And, like an ugly brute staring into a mirror, we needn\'t rush to see the anger and confusion in the reflection of the idol\'s absence. Leave, warrior, before the people see you\'ve not returned with the %item%.%SPEECH_OFF%}",
			Image = "",
			Characters = [],
			List = [],
			ShowEmployer = false,
